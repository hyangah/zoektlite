...
// GetHash returns the hash of the options.
// Note that this hash is not collision resistant.
func (o *Options) GetHash() string {
	h := o.HashOptions()
	hasher := sha1.New()
	// TODO(hakim): migrate to sha256 once all producers of the old hash are moved.
